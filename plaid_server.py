...
@plaid_router.post("/api/create_link_token")
...
@plaid_router.post("/api/set_access_token")
...
@plaid_router.get("/api/transactions")
...
@plaid_router.get("/api/investments_transactions")
...
@plaid_router.get("/api/statements")
def statements():
    try:
