...
- [app-stack/](./app-stack/README.md) owns the Compose runtime template for `nginx + backend + worker + postgres`, per-environment runtime env templates, and the deploy script.
...
- two isolated first-pass environments on the same host: `public` and `prod`
